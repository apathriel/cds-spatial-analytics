...
st_crs(places_sf)
st_crs(nitrates_sf)
# neither have a defined CRS it seems, not sure if you can get the proj string or not

show(elevation)
# rasterlayer class, think it might mean single, but not sure.
# uses WGS84, has a prof string.
# think it might have 0 attributes?
# dims look like this 396, 876, 346896  (nrow, ncol, ncell)
# the resolution is defined as 0.008333333, 0.008333333. not sure what that means
# maybe we can if we convert places & nitrates to the same CRS as elevation
